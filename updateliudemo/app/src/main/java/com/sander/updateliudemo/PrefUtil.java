...
public class PrefUtil {
    ...
    static private String KEY_STREAM_ROOT  = "_key_stream_root";
    ...
    private PrefUtil() {
        mPref = LiuApplication.getAppContext().getSharedPreferences("__global_pref", Context.MODE_PRIVATE);
    }
    ...
    public boolean getStreamRoot() {
        return mPref.getBoolean(KEY_STREAM_ROOT,false);
    }

    public void setStreamRoot(boolean streamRoot) {
        setBoolean(KEY_STREAM_ROOT,streamRoot);
    }
